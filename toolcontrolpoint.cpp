...
ToolControlPoint::ToolControlPoint(VideoViewBase *parent)
	: ToolImage(parent)
{
	mPrePoint.setX(-1);
	mPrePoint.setY(-1);
...
ToolControlPoint::~ToolControlPoint()
{

}

void ToolControlPoint::mousePress( QMouseEvent *mouseEvent )
{	
	mouseEvent->ignore();
...
void ToolControlPoint::keyPress( QKeyEvent *keyEvent )
{
